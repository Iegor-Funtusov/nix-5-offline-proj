...
import ua.com.alevel.ValidString;
    ...
    public static void stringValidator() throws IOException {
        ...
        switch (reader.readLine()) {
            case "1": {
                ...
                System.out.println("Is this string valid: " + ValidString.isValid(input));
            }
            break;
            case "2": {
                String result = randomString();
                System.out.println("Generated string: " + result);
                System.out.println("Valid string?: " + ValidString.isValid(result));
            }
            break;
            case "3": {
