...
public class Interface {
    ...
    private static void autoTest() {
        Integer[] numbers1 = new Integer[]{17, 12, 8};
        Integer[] numbers2 = new Integer[]{9, 31, 6};
        Integer[] numbers3 = new Integer[]{5, 25, 87};
        ...
        System.out.println("mathSet3 + " + "9, 3, 78, 76");
    ...
    private static void addToSet() throws IOException {
        String str;
        System.out.println("Please select the type of set ");
        do {
            System.out.println("1 Integer values ");
            System.out.println("2 Floating point");
            System.out.println("0 Back - \"0\"");
