...
public class UserInterfaceService {
    ...
    private static void printAuthors() {
        for (int i = 0; i < managementService.getAllAuthors().length; i++) {
            System.out.println(i + 1 + " " + managementService.getAllAuthors()[i]);
        }
        System.out.println();
    }

    private static void printBooks() {
        for (int i = 0; i < managementService.getAllBooks().length; i++) {
            System.out.println(i + 1 + " " + managementService.getAllBooks()[i]);
        }
        System.out.println();
    }
